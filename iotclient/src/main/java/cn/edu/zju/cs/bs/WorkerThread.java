...
public class WorkerThread extends Thread {
    ...
    public void run() {
        try {
            ...
            double startx = 119.9 + rand.nextFloat() * 0.6;
            double starty = 30.1 + rand.nextFloat() * 0.4;
            while (running) {
                //随机等待10秒
                ...
                rand.nextFloat();
                //根据杭州经纬度随机生成设备位置信息
                startx += rand.nextFloat() *0.03 - rand.nextFloat() *0.03;
                starty += rand.nextFloat() *0.03 - rand.nextFloat() *0.03;
